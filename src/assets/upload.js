...
class MyUploadAdapter {
  ...
  _initRequest() {
      ...
      xhr.open( 'POST', process.env.VUE_APP_BASE_URL + '/forum/upload_image/', true );
  ...
  _initListeners( resolve, reject, file ) {
      ...
      xhr.addEventListener( 'load', () => {
          ...
          //上传成功，从后台获取图片的url地址
          resolve( {
              default: process.env.VUE_APP_BASE_URL + '/' + response.data[0]
          } );
      } );
  ...
  _sendRequest( file ) {
      ...
      data.append( 'id', route.query.category );
      /**

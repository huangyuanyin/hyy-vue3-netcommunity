    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="header-user-con">
                ...
                <!-- 消息中心 -->
                <div class="btn-bell">
                    <el-tooltip effect="dark" :content="message?`有${message}条未读消息`:`消息中心`"
                        placement="bottom">
                        <router-link to="/detail">
                            <i><el-icon style="margin-top: 5px"><bell /></el-icon></i>
                ...
                <div class="help">
                  <el-tooltip placement="bottom" trigger="hover" content="帮助文档" class="document">
                    <i><el-icon style="color: #909399"><question-filled /></el-icon></i>
                  </el-tooltip>
                </div>
                <!-- 用户头像 -->
                ...
                <el-dropdown class="user-name" trigger="click">
                    <span class="el-dropdown-link">
                        {{username}}
                        <i><el-icon><caret-bottom /></el-icon></i>
                    </span>
                    <template #dropdown>
                        <el-dropdown-menu>
